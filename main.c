...
*    3. Compares the GPIO input voltages.
*
* Parameters:
*  void
*
...
int main(void)
{
    ...
    {
        #if PDL_CONFIGURATION
            /* Control P2.0 based on the comparison result */
            Cy_GPIO_Write(GPIO_PRT2, 0, Cy_LPComp_GetCompare(LPCOMP, CY_LPCOMP_CHANNEL_0));
        #endif
    }
}
